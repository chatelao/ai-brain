  ...
  if (projectError || !project) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-50">
        ...
        <Link href={toApp('/')} className="mt-4 text-blue-600 hover:underline">
          Back to Dashboard
        </Link>
      </div>
    );
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <nav className="flex mb-2" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2 text-sm text-gray-500">
                <li><Link href={toApp('/')} className="hover:text-gray-700">Dashboard</Link></li>
          ...
          <div className="flex space-x-3">
            ...
            <Link
              href={toApp(`/projects/${id}/settings`)}
                      ...
                      <tr key={task.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex flex-col">
                            <Link href={toApp(`/tasks/${task.id}`)} className="text-sm font-bold text-blue-600 hover:underline">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <Link href={toApp(`/tasks/${task.id}`)} className="text-blue-600 hover:text-blue-900">
                            Details
                          </Link>
                        </td>
                      </tr>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
              ...
              {templates && templates.length > 0 ? (
                ...
                <p className="text-sm text-gray-500 italic">
                  No templates found.{' '}
                  <Link href={toApp('/templates')} className="text-blue-600 hover:underline">
                    Create one here.
                  </Link>
                </p>
              )}

...
$pdo->exec("INSERT INTO tasks (task_id, user_id, project_id, issue_number, title, body, status, jules_status, pr_url, jules_url, github_pr_data, github_data_updated_at)
            VALUES (101, 1, 1, 101, 'Mock Task Title', 'This is a mock task description.', 'PROCESSING', 'coding', 'https://github.com/owner/repo/pull/1', 'https://jules.example.com/session/1', '{\"state\":\"open\",\"mergeable_state\":\"clean\",\"draft\":false}', '$now')");
